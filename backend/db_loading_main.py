...
import time
from backend.data_model.time_series import MachoFileDataBase, MultibandTimeSeries, TimeSeriesBand, MongoTimeSeriesDataBase
...
def load_macho_field_to_mongo(field):
    ...
    mongo_db = MongoTimeSeriesDataBase('lightcurves')
